...
if (isset($_POST['displayButton'])) {
    ...
    if (isset($_SESSION['user']['user'])) {
        ...
        if ($result && mysqli_num_rows($result) > 0) {
            ...
            $userProfile .= "<tr><td>Year of Entry:</td><td>" . $row['entry_year'] . "</td></tr>";
            $userProfile .= "<tr><td>Year of Exit:</td><td>" . $row['exit_year'] . "</td></tr>";
            $userProfile .= "</table>";
        } else {
...
<html>
<head>
    <title>CUEA Complaint System - Student Page</title>
...
<body>
    ...
    <main>
        <nav>
            <ul>
                <li class="manage">
                    <button id="clearanceButton">Complaints</button>
                    <!-- Clearance display element -->
                    <div id="clearanceDisplay">
                        <ul class="submenu">
                            <li><a href="clearance_form.php">Initiate Complaint</a></li>
