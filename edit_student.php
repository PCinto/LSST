    ...
    <div class="form-container">
      <?php
        ...
        if ($result->num_rows == 1) {
          ...
          echo '</select>';
          echo '<label for="entry_year">Year of Entry:</label>';
          echo '<input type="number" name="entry_year" value="'.$row["entry_year"].'" required>';
          echo '<label for="exit_year">Year of Exit:</label>';
          echo '<input type="number" name="exit_year" value="'.$row["exit_year"].'" required>';
