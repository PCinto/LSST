...
<html>
<head>
	<title> Complaint Management System - HOD Page</title>
		...
		<nav>
			<ul>
				<li class="manage">
					...
					<ul class="submenu">
						<li><a href="clearance_request.php">Check complaints request</a></li>
						<li><a href="finance_declined_report.php">Declined complaints reports</a></li>
                        <li><a href="finance_accepted_report.php">Approved complaints reports</a></li>
